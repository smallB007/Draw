...
#include <afxext.h>
#include "..\MFC_Draw\MFC_DrawDoc.h"
#include "..\MFC_Draw\MFC_DrawView.h"
...
public:
	virtual HRESULT InitializeDocumentPreview(HWND hWndParent, RECT* prc)
	{
		...
		CCreateContext ctx;
		ctx.m_pNewViewClass = RUNTIME_CLASS(CMFC_DrawView);
		...
		m_pDocument->AddRef();
		ctx.m_pCurrentDoc = DYNAMIC_DOWNCAST(CMFC_DrawDoc, (CObject*) m_pDocument->GetContainer());
